...
public class GraphTest extends DSUnitTesting {
	...
	public void calculateTotalWeight() {
		...
		try {
			Assert.assertEquals("Test that the path cost is correctly calculated", 68.20, g.calculateTotalWeight(path),
					0.01);
	...
	public void dijkstrasSearch() {
		...
		exp_path = new Node[]{nodes[8], nodes[7], nodes[17], nodes[16], nodes[15], nodes[14], nodes[4],
